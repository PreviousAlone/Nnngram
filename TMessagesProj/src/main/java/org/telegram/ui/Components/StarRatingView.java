...
public class StarRatingView extends View {
    ...
    private static class Colors {
        ...
        public void reset() {
            ...
            backgroundColor = fillingTextColor = getTabsViewBackgroundColor(resourcesProvider, color2, color1, parentExpanded);//Theme.blendOver(Theme.getColor(Theme.key_avatar_backgroundActionBarBlue), Theme.multAlpha(Color.BLACK, 0.1f));
            backgroundTextColor = fillingColor = Theme.getColor(Theme.key_actionBarDefaultTitle, resourcesProvider); //0xFFFFFFFF;
