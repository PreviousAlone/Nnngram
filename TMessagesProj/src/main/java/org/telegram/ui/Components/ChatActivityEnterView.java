...
//        }
    ...
    public void checkSendButton(boolean animated) {
        ...
        if (slowModeTimer > 0 && slowModeTimer != Integer.MAX_VALUE && !isSlowModeIgnored()) {
            ...
            if (audioVideoButtonContainer.getVisibility() == VISIBLE || (Config.hideQuickSendMediaBottom && sendButton.getVisibility() == VISIBLE) || slowModeButton.getVisibility() == VISIBLE || showBotButton || showSendButton || animatorIsBlockedByStreaming.getValue()) {
                if (animated) {
            ...
            if (animated) {
                ...
                animators.add(ObjectAnimator.ofFloat(audioVideoSendButton, View.SCALE_X, 1.0f));
                animators.add(ObjectAnimator.ofFloat(audioVideoSendButton, View.SCALE_Y, 1.0f));
...
//        }
    ...
    public View getSendButton() {
        return getSendButtonInternal().getVisibility() == VISIBLE || Config.hideQuickSendMediaBottom ? getSendButtonInternal() : audioVideoButtonContainer;
    }
    ...
    public void updateSendAsButton(boolean forceHide, boolean animated) {
        ...
        final boolean isVisible = (((chat != null && chat.creator) || UserConfig.getInstance(currentAccount).isPremium()) || ChatObject.isChannel(chat))
            && !forceHide && defPeer != null
