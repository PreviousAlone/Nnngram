...
//            }
    ...
    public void recreateFormatters() {
        ...
        Locale localeForDay = lang.equalsIgnoreCase("ar") || lang.equalsIgnoreCase("ko") ? locale : Locale.US;
        ...
        formatterDay = createFormatter(localeForDay, is24HourFormat ? getStringInternal("formatterDay24H", R.string.formatterDay24H) : getStringInternal("formatterDay12H", R.string.formatterDay12H), is24HourFormat ? "HH:mm" : "h:mm a");
        formatterDayWithSeconds = createFormatter(localeForDay, is24HourFormat ? getStringInternal("formatterDay24HSec", R.string.formatterDay24HSec) : getStringInternal("formatterDay12HSec", R.string.formatterDay12HSec), is24HourFormat ? "HH:mm:ss" : "h:mm:ss a");
