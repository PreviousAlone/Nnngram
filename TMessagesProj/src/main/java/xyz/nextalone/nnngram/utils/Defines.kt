...
//    const val ciChannel = 2
    ...
    @IntConfig(1500) const val deepLxMaxCharacters = "deepLxMaxCharacters"
    @IntConfig(1) const val deepLxRequestsPerSecond = "deepLxRequestsPerSecond"
    @BooleanConfig(true) const val deepLxPreserveFormatting = "deepLxPreserveFormatting"
